...
static double find_inverse_gamma(double a, double p, double q) {
    ...
    if (a == 1) {
        ...
        if ((b > 0.6) || ((b >= 0.45) && (a >= 0.3))) {
            ...
            double u = y - (1 - a) * log(y);
            result =
                y - (1 - a) * log(u) - log((u * u + 2 * (3 - a) * u + (2 - a) * (3 - a)) / (u * u + (5 - a) * u + 2));
        } else {
            ...
            double c4 =
                (a - 1) * ((c1_3 / 3) - (3 * a - 5) * c1_2 / 2 + (a_2 - 6 * a + 7) * c1 + (11 * a_2 - 46 * a + 47) / 6);
            double c5 =
                (a - 1) * (-(c1_4 / 4) + (11 * a - 17) * c1_3 / 6 + (-3 * a_2 + 13 * a - 13) * c1_2 +
                           (2 * a_3 - 25 * a_2 + 72 * a - 61) * c1 / 2 + (25 * a_3 - 195 * a_2 + 477 * a - 379) / 12);
