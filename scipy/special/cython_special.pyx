...
cdef extern from r"special_c_wrappers.h":
...
cpdef Dd_number_t gamma(Dd_number_t x0) noexcept nogil:
    ...
    if Dd_number_t is double_complex:
        ...
        return (<double(*)(double) noexcept nogil>scipy.special._ufuncs_cxx._export_cephes_Gamma)(x0)
    else:
        if Dd_number_t is double_complex:
            return NAN
        else:
...
cpdef Dd_number_t hyp2f1(double x0, double x1, double x2, Dd_number_t x3) noexcept nogil:
    ...
    if Dd_number_t is double:
        return (<double(*)(double, double, double, double) noexcept nogil>scipy.special._ufuncs_cxx._export_cephes_hyp2f1)(x0, x1, x2, x3)
    elif Dd_number_t is double_complex:
...
cpdef Dd_number_t iv(double x0, Dd_number_t x1) noexcept nogil:
    ...
    if Dd_number_t is double_complex:
        ...
        return _func_cephes_iv_wrap(x0, x1)
    else:
        if Dd_number_t is double_complex:
            return NAN
        else:
...
cpdef Dd_number_t rgamma(Dd_number_t x0) noexcept nogil:
    ...
    if Dd_number_t is double_complex:
        ...
        return (<double(*)(double) noexcept nogil>scipy.special._ufuncs_cxx._export_cephes_rgamma)(x0)
    else:
        if Dd_number_t is double_complex:
            return NAN
        else:
