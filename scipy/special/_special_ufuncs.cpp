...
using func_F_FpFpFpFp_t = void (*)(complex<float>, complex<float> *, complex<float> *, complex<float> *,
                                   complex<float> *);
using func_D_DpDpDpDp_t = void (*)(complex<double>, complex<double> *, complex<double> *, complex<double> *,
                                   complex<double> *);
